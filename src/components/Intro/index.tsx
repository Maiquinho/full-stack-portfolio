...
export function Intro() {
  return (
    <section className="flex flex-col gap-8 lg:gap-16 pt-5 lg:pt-10 mt-4 lg:mt-12 relative after:content-[''] after:bg-[url('/assets/main-banner-code-bg.png')] after:absolute after:top-0 after:right-0 after:block after:bg-no-repeat after:w-[309px] lg:after:w-[409px] after:h-[361px] lg:after:h-[461px]">
